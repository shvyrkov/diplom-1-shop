  <section class="shop-page__order" hidden="">
    <div class="shop-page__wrapper">
      ...
      <form action="/hendlers/shopOrder.php" method="post" class="custom-form js-order">
        <fieldset class="custom-form__group">
          ...
          <div class="custom-form__column">
            ...
            <label class="custom-form__input-wrapper" for="firstName">
              <input id="name" class="custom-form__input" type="text" name="firstName" required="">
            ...
            <!-- <input type="text" name="productId" value="productId - передать из каталога, сделать hidden<?php // @TODO: Передать из каталога ?>"> -->
          </div>
        </fieldset>
        ...
        <div class="shop-page__delivery shop-page__delivery--no">
          <table class="custom-table">
            ...
            <tr>
              ...
              <td class="date"><?=date("d.m.Y", mktime(0, 0, 0, date("m"), date("d")+2, date("Y"))) ?> — <?=date("d.m.Y", mktime(0, 0, 0, date("m"), date("d")+4, date("Y")))?></td>
            </tr>
          </table>
        </div>
        ...
        <button class="button" type="submit" name="submit">Отправить заказ</button>
      </form>
    </div>
  </section>
