<?php 
 ...
 include $_SERVER['DOCUMENT_ROOT'] . '/templates/header.php'; // Заголовок для всех страниц 
?>
...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=COURIER_PRICE ?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=COURIER_FREE_MIN_PRICE ?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=URGENT_COURIER_PRICE ?> РУБ</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=COURIER_PRICE ?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=COURIER_FREE_MIN_PRICE ?> РУБ)</b>
        <p class="page-delivery__item-desc">
